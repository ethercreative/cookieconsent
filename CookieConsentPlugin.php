...
class CookieConsentPlugin extends BasePlugin
{
	...
	{
		return Craft::t('Simple cookie consent plugin');
	}
	...
	{
		return 'https://github.com/ethercreative/cookieconsent/blob/master/README.md';
	}
	...
	{
		return 'https://raw.githubusercontent.com/ethercreative/cookieconsent/master/releases.json';
	}
	...
	{
	   return craft()->templates->render('cookieconsent/settings', array(
